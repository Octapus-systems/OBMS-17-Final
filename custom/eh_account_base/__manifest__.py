...
##############################################################################
{
    ...
    'description': """The shared engine that powers the ERP Heritage accounting modules for Odoo 17 Community. It auto-installs as a dependency of any ERP Heritage accounting module, so you do not need to install it by hand.
